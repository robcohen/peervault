...
import { getConflictTracker, type ConflictInfo } from '../core/conflict-tracker';
...
export class ConflictModal extends Modal {
  ...
  private renderConflicts(container: HTMLElement, conflicts: ConflictInfo[]): void {
  ...
  private renderActions(container: HTMLElement, conflicts: ConflictInfo[]): void {
