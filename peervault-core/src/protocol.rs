...
// ============================================================================
// Mesh Protocol Messages (/pv/mesh/1)
// ============================================================================

pub mod mesh {
    use super::*;

    /// Peer info for mesh discovery
    #[derive(Debug, Clone, Serialize, Deserialize)]
    pub struct PeerInfo {
        pub node_id: String,
    ...
    /// Message type tags for mesh protocol
    #[repr(u8)]
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
    pub enum MessageType {
        /// Announce discovered peers
        PeerAnnouncement = 0x21,
        /// Request peers for groups
        PeerRequest = 0x22,
    ...
    impl TryFrom<u8> for MessageType {
        ...
        fn try_from(v: u8) -> Result<Self, ()> {
            match v {
                0x21 => Ok(Self::PeerAnnouncement),
                0x22 => Ok(Self::PeerRequest),
                0x23 => Ok(Self::PeerLeft),
                _ => Err(()),
            }
        }
    }
    ...
    pub struct PeerAnnouncement {
        ...
        pub reason: String, // "joined", "discovered", "updated"
    }
    ...
    pub struct PeerLeft {
        pub node_id: String,
        pub group_ids: Vec<String>,
        pub reason: String, // "removed", "disconnected", "left"
    }
    ...
    impl Message {
        pub fn encode(&self) -> io::Result<Vec<u8>> {
            let tag = match self {
                Message::PeerAnnouncement(_) => MessageType::PeerAnnouncement as u8,
                Message::PeerRequest(_) => MessageType::PeerRequest as u8,
                Message::PeerLeft(_) => MessageType::PeerLeft as u8,
            };
